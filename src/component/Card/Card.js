...
const Card = (props) => {
  ...
  return (
    <div>
      ...
      lg:h-[442px] lg:w-[279px] hover:border-[#4E90A8] hover:shadow-xl relative"
      >
        ...
        <div className="mt-[8px] px-[12px] ">
          <div className="flex justify-between">
            <h2 className="font-normal text-[14px] lg:text-[16px] text-[#142B33] line-clamp-2">
              {property_name}
            </h2>
            <div className="flex justify-center items-center mt-[4] text-[12px] lg:text-[14px]">
          ...
          <div className="flex justify-start items-center mt-[4px] gap-[4px]">
            ...
            <p className="text-[12px] lg:text-[14px]  text-gray-800">
              {short_address?.slice(0, 30) +
                (short_address?.length > 30 ? "..." : "")}
            </p>
          </div>
          <div className="flex justify-start items-start mt-[12px] gap-[4px]">
            ...
            <p className="text-[12px] lg:text-[14px] pl-[4px] text-gray-800 ">
              {property_tag}
            </p>
          </div>
